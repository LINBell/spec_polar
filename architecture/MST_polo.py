...
class MST_polo(nn.Module):
    def __init__(self, dim=21*4, stage=3, num_blocks=[2,2,2], need_noise=False, num_sp=5, need_mask_atten=False, raw_flag=False):
        ...
        # Input projection
        self.embedding = nn.Conv2d(21*4, self.dim, 3, 1, 1, bias=False)
