...
train_set = random_load_spec_polo(opt.data_path, opt.select_num, norm=True, add_reflect=True)
test_data = LoadTraining_npy_spec_polo(opt.test_path, norm=True, add_reflect=True)
