...
model = unet(CHANNEL=21, channel_nums=64, kernel_size=5, raw_flag=True).cuda()

model_path = '9_9/basic/model/model_epoch_265.pth'
model_path = '9_9/shuffle/model/model_epoch_171.pth'
model_path = 'ablation_test/cnn_only_spec/model/model_epoch_127.pth'
model_path = 'ablation_test/cave_data_cnn_only_spec/model/model_epoch_197.pth'
# model_path = 'ablation_test/new_data_spec_only/model/model_epoch_5.pth'
