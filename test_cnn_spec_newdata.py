...
model = unet(CHANNEL=18, channel_nums=64, kernel_size=5, raw_flag=True).cuda()
...
model_path = 'ablation_test/new_data_spec_only/model/model_epoch_199.pth'
...
with torch.no_grad():
    ...
    model_out = model_out.view(batch_size, 18, h, w).squeeze(0)
