...
train_set = LoadTraining_gen_polar(train_path, opt.select_num)
test_data = LoadTest_gen_polar(test_path).permute(0, 3, 4, 1, 2)
print(f'Train set shape: {train_set[0].shape}')  # 1024 1024 21
print(f'Test data length: {test_data.shape}') # 9 21 256 256
