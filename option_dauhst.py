...
parser.add_argument('--outf', type=str, default='./exp/dauhst/', help='saving_path')

# Model specifications
parser.add_argument('--method', type=str, default='dauhst_9', help='method name')
...
parser.add_argument("--select_num", type=int, default='280')
...
opt.data_path = "/data8T/lzj/spec_polo_train/hyperspectral/train"    #
opt.test_path = "/data8T/lzj/spec_polo_train/hyperspectral/test"    # 10013
